...
# django-filter permite filtrar por campos especificados.
# ordering_fields añade ordenamiento ascendente o descendente.
    ...
    # @action crea una ruta adicional que no es parte del CRUD automático.
    # detail=True significa que requiere un ID. Ej: /api/libros/1/resenas/
